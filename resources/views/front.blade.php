        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="post post-thumb">
                    ...
                    <div class="post-body">
                        <div class="post-meta">
                            <a class="post-category cat-1" href="{{ route('artikel.kategori',$a->kategori) }}">{{$a->kategori->nama_kategori}}</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="post">
                            ...
                            <div class="post-body">
                                <div class="post-meta">
                                    <a class="post-category cat-1" href="{{ route('artikel.kategori',$all->kategori) }}">
